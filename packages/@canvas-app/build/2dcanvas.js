;(function webpackUniversalModuleDefinition(root, factory) {
					...
					var CanvasContoller = /** @class */ (function (_super) {
						...
						CanvasContoller.prototype.bindMousemoveEvent = function () {
							...
							document.addEventListener('mousemove', function (evte) {
								...
								if (
									evte.clientX - _this.config.canvasRect.left <= 0 ||
  ...
  \**************************************/
				/***/ (__unused_webpack_module, exports) => {
					...
					var EventsBus = /** @class */ (function () {
						function EventsBus() {
							this.events = {}
						}
						EventsBus.prototype.on = function (name, callback) {
						...
						EventsBus.prototype.emit = function (name) {
